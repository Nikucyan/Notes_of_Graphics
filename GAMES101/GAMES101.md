...
- **Grayscale Snapshot**
  ...
  The intensity of light $P(\theta, \phi)$ 
...
- **Color Snapshot** 
  ...
  The intensity of light $P(\theta,\phi,\lambda)$ (introduce the wavelength)

- **A Movie**

  Add time: $P(\theta,\phi,\lambda, t)$

- **Holographic Movie**

  Add location: $P(\theta,\phi,\lambda, t, V_X, V_Y, V_Z)$
...
<img src="https://cdn.jsdelivr.net/gh/Nikucyan/MD_IMG//img/image-20220112235959511.png" alt="image-20220112235959511" style="zoom:50%;" />

#### Ray

Ignore the time and color at the moment: 5D (3D position + 2D direction) $P(\theta,\phi,V_X,V_Y,V_Z)$ 
...
<img src="https://cdn.jsdelivr.net/gh/Nikucyan/MD_IMG//img/image-20220113000425315.png" alt="image-20220113000425315" style="zoom:80%;" />

**Lightfield**: The <u>intensity</u> of light from <u>any position</u> to <u>any direction</u> (2D pos + 2D dir) 

**Synthesizing novel views**  

<img src="https://cdn.jsdelivr.net/gh/Nikucyan/MD_IMG//img/image-20220113000719480.png" alt="image-20220113000719480" style="zoom:50%;" />
...
<img src="https://cdn.jsdelivr.net/gh/Nikucyan/MD_IMG//img/image-20220113002452425.png" alt="image-20220113002452425" style="zoom:50%;" />

**Organization**: <u>2 planes</u> (parameterization: uv and st) can define a lightfield

<img src="https://cdn.jsdelivr.net/gh/Nikucyan/MD_IMG//img/image-20220113002708739.png" alt="image-20220113002708739" style="zoom:50%;" />			<img src="https://cdn.jsdelivr.net/gh/Nikucyan/MD_IMG//img/image-20220113002914819.png" alt="image-20220113002914819" style="zoom:50%;" />

Hold st, vary uv => an image

![image-20220113003011384](https://cdn.jsdelivr.net/gh/Nikucyan/MD_IMG//img/image-20220113003011384.png)

**Integral Imaging (“Fly’s Eye” Lenslets)**

<img src="https://cdn.jsdelivr.net/gh/Nikucyan/MD_IMG//img/image-20220113003332328.png" alt="image-20220113003332328" style="zoom:80%;" />

<u>Spatially-multiplexed light field capture</u> using lenslets: Impose fixed trade-off between <u>spatial</u> and <u>angular</u> resolution  

### Light Field Camera

[Ren Ng] Microlens design => <u>Computational Refocusing</u> (virtually changing focal length & aperture size, etc. after taking a photo)

#### Understanding

- Each pixel (irradiance) is now stored as <u>a block of pixels</u> (radiance) (The pixel is now the microlens)
- A close-up view of a picture taken  

<img src="https://cdn.jsdelivr.net/gh/Nikucyan/MD_IMG//img/image-20220113003853466.png" alt="image-20220113003853466" style="zoom:80%;" /> <img src="https://cdn.jsdelivr.net/gh/Nikucyan/MD_IMG//img/image-20220113003942494.png" alt="image-20220113003942494" style="zoom:50%;" />
...
<img src="https://cdn.jsdelivr.net/gh/Nikucyan/MD_IMG//img/image-20220113004306452.png" alt="image-20220113004306452" style="zoom:50%;" />
...
- The light field contains <u>everything</u>

**Problem**:

- Insufficient spatial <u>resolution</u> (same film used for both spatial and directional information)
- High <u>cost</u> (intricate designation of microlenses)
...
![image-20220113114111425](https://cdn.jsdelivr.net/gh/Nikucyan/MD_IMG//img/image-20220113114111425.png)
...
<img src="https://cdn.jsdelivr.net/gh/Nikucyan/MD_IMG//img/image-20220113114242945.png" alt="image-20220113114242945" style="zoom:80%;" />
...
<img src="https://cdn.jsdelivr.net/gh/Nikucyan/MD_IMG//img/image-20220113114646978.png" alt="image-20220113114646978" style="zoom: 33%;" />
...
- **Rods**: primary receptors in very low light (“scotopic” conditions) => more
  ...
  Perceive only shades of <u>grey</u>, <u>no color</u> (the luminance)

- **Cones**: primary receptors in typical light levels (“photopic”)  => fewer

  3 types (S/M/L) for different spectral sensitivity; Provide sensation of <u>color</u>

<img src="https://cdn.jsdelivr.net/gh/Nikucyan/MD_IMG//img/image-20220113115103092.png" alt="image-20220113115103092" style="zoom:67%;" />

### Spectral Response of Human Cone Cells

Three types: S, M, L (corres to peak response at low / medium / long wavelengths)

<img src="https://cdn.jsdelivr.net/gh/Nikucyan/MD_IMG//img/image-20220113115240954.png" alt="image-20220113115240954" style="zoom: 67%;" />

But the distributions of the 3 types of cone cells in different people are very <u>different</u>
...
From the prev graph: 
$$
S = \int r_S (\lambda) s (\lambda)\ \mathrm{d}\lambda\ ;\quad M = \int r_M (\lambda) s (\lambda)\ \mathrm{d}\lambda\ ;\quad L = \int r_L (\lambda) s (\lambda)\ \mathrm{d}\lambda\ ;\quad 
$$
...
<img src="https://cdn.jsdelivr.net/gh/Nikucyan/MD_IMG//img/image-20220113115849174.png" alt="image-20220113115849174" style="zoom: 50%;" />
...
Metamers are 2 different spectra ($\infty$-dim) that project to the same (S, M, L) (3-dim) response
...
<img src="https://cdn.jsdelivr.net/gh/Nikucyan/MD_IMG//img/image-20220113130425592.png" alt="image-20220113130425592" style="zoom:67%;" />
...
Same as before but <u>primaries</u> are **monochromatic** light (single wavelength) and the <u>test</u> light is also a monochromatic light

<img src="https://cdn.jsdelivr.net/gh/Nikucyan/MD_IMG//img/image-20220113171545597.png" alt="image-20220113171545597" style="zoom:45%;" />
...
<img src="https://cdn.jsdelivr.net/gh/Nikucyan/MD_IMG//img/image-20220113171627886.png" alt="image-20220113171627886" style="zoom:40%;" />
$$
R_{\text{CIE RGB}} = \int_{\lambda} s(\lambda) \overline r(\lambda)\ \mathrm{d}\lambda\ ;\quad 
G_{\text{CIE RGB}} = \int_{\lambda} s(\lambda) \overline g(\lambda)\ \mathrm{d}\lambda\ ; \quad
B_{\text{CIE RGB}} = \int_{\lambda} s(\lambda) \overline b(\lambda)\ \mathrm{d}\lambda
$$
...
<img src="https://cdn.jsdelivr.net/gh/Nikucyan/MD_IMG//img/image-20220113172534210.png" alt="image-20220113172534210" style="zoom:80%;" />
...
<img src="https://cdn.jsdelivr.net/gh/Nikucyan/MD_IMG//img/image-20220113172845672.png" alt="image-20220113172845672" style="zoom:50%;" />

- Luminance: Y

- Chromaticity: x, y, z, defined as: ($x+y+z=1$ (normalized), only need to record 2 of three, usually $(x,y)$)
  $$
...
<img src="https://cdn.jsdelivr.net/gh/Nikucyan/MD_IMG//img/image-20220113173115648.png" alt="image-20220113173115648" style="zoom:67%;" />

The curved <u>boundary</u>:

- Named spectral locus
- Corresponds to monochromatic light (each point represnting a <u>pure</u> color of a single wavelength)

Any color inside is less pure (mixed, <u>white</u> is the least pure color)
...
<img src="https://cdn.jsdelivr.net/gh/Nikucyan/MD_IMG//img/image-20220113173319061.png" alt="image-20220113173319061" style="zoom:67%;" />
...
<img src="https://cdn.jsdelivr.net/gh/Nikucyan/MD_IMG//img/image-20220113173527131.png" alt="image-20220113173527131" style="zoom:50%;" />
...
<img src="https://cdn.jsdelivr.net/gh/Nikucyan/MD_IMG//img/image-20220113173937415.png" alt="image-20220113173937415" style="zoom:80%;" />
...
<img src="https://cdn.jsdelivr.net/gh/Nikucyan/MD_IMG//img/image-20220113174815438.png" alt="image-20220113174815438" style="zoom:50%;" />
